...
static const DWORD	SERVO_MINI_IN_BITMASK_USERIN6		= 0x00000200;
...
typedef enum
{
	...
	MAX_SERVO_MINI_OUT_LOGIC
} EZISERVO_MINI_OUTLOGIC_LIST;

static const int	SERVO_MINI_IN_PIN_CNT	= 10;
static const int	SERVO_MINI_OUT_PIN_CNT	= 2;

static const int	SERVO_MINI_IN_LOGIC_CNT			= (MAX_SERVO_MINI_IN_LOGIC - 1);
static const int	SERVO_MINI_MAX_PREASSIGNED_IN	= (SERVO_MINI_IN_PREASSIGN_ORIGIN);

static const int	SERVO_MINI_OUT_LOGIC_CNT		= (MAX_SERVO_MINI_OUT_LOGIC - 1);
static const int	SERVO_MINI_MAX_PREASSIGNED_OUT	= (SERVO_MINI_OUT_PREASSIGN_COMP);
...
#define SERVO_MINI_MAX_ITEM_COUNT		64
