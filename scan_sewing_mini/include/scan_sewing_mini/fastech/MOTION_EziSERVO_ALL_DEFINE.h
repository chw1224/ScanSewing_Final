...
static const DWORD	SERVO_ALL_IN_BITMASK_USERIN6		= 0x00000200;
...
typedef enum
{
	...
	MAX_SERVO_ALL_OUT_LOGIC
} EZISERVO_ALL_OUTLOGIC_LIST;

static const int	SERVO_ALL_IN_PIN_CNT	= 10;
static const int	SERVO_ALL_OUT_PIN_CNT	= 2;

static const int	SERVO_ALL_IN_LOGIC_CNT			= (MAX_SERVO_ALL_IN_LOGIC - 1);
static const int	SERVO_ALL_MAX_PREASSIGNED_IN	= (SERVO_ALL_IN_PREASSIGN_ORIGIN);

static const int	SERVO_ALL_OUT_LOGIC_CNT			= (MAX_SERVO_ALL_OUT_LOGIC - 1);
static const int	SERVO_ALL_MAX_PREASSIGNED_OUT	= (SERVO_ALL_OUT_PREASSIGN_COMP);
...
typedef enum
{
	...
	SERVO_ALL_POSVALUECOUNTINGMETHOD,
...
#define SERVO_ALL_MAX_ITEM_COUNT		64
