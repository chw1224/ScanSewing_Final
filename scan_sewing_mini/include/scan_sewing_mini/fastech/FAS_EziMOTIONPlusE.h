...
#include <windows.h>
	...
	#pragma comment( lib, "C:\\catkin_ws\\src\\ScanSewing\\scan_sewing_mini\\include\\scan_sewing_mini\\fastech\\EziMOTIONPlusE.lib" )
...
EZI_PLUSE_API int WINAPI	FAS_EnableTwoTCPPort(int iBdID, BOOL bEnable);
