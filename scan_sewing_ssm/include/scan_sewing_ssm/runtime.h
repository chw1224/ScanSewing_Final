...
/* 64bit�� �����Ͻ� ��ó���� ����(Preprocessor definitions)���� WIN32 ���� WIN64�� �����ϼž� �մϴ�. */
#ifdef WIN64
  #define DRIVERNAME          TEXT("Pcomm64.dll") //name of the user-dll 64 Bit driver
#else
  #define DRIVERNAME          TEXT("Pcomm64.dll") //name of the user-dll 32 Bit driver
#endif
...
extern "C" {
  ...
  EXTRN SENDLINEW DeviceSendLineW;							// 2016.08.03. �߰�
  EXTRN GETLINEA DeviceGetLine;
  EXTRN GETLINEW DeviceGetLineW;							// 2016.08.03. �߰�
  EXTRN GETLINEEXA DeviceGetLineEx;
  EXTRN GETLINEEXW DeviceGetLineExW;						// 2016.08.03. �߰�
  EXTRN WAITGETLINEA DeviceWaitGetLine;
  EXTRN SENDCHARA DeviceSendChar;
  EXTRN GETRESPONSEA DeviceGetResponse;
  EXTRN GETRESPONSEW DeviceGetResponseW;					// 2016.08.03. �߰�
  EXTRN GETCONTROLRESPONSEA DeviceGetControlResponse;
  EXTRN GETCONTROLRESPONSEW DeviceGetControlResponseW;		// 2016.08.03. �߰�
  EXTRN GETRESPONSEEXA DeviceGetResponseEx;
  EXTRN GETRESPONSEEXW DeviceGetResponseExW;				// 2016.08.03. �߰�
  EXTRN GETCONTROLRESPONSEEXA DeviceGetControlResponseEx;
  EXTRN GETCONTROLRESPONSEEXW DeviceGetControlResponseExW;	// 2016.08.03. �߰�
