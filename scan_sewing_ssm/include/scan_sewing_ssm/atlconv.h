...
#define VERIFY_STACK_FOR_A2W(lpa)\
    (((_lpa = (lpa))!= NULL)?\
        (_convert=static_cast<int>(strlen(_lpa))+1,(INT_MAX/2<_convert)?\
            FALSE:ATL::_ATL_SAFE_ALLOCA_IMPL::_AtlVerifyStackAvailable(_convert*sizeof(WCHAR))):FALSE)

#define VERIFY_STACK_FOR_W2A(lpw)\
    (((_lpw = (lpw))!= NULL)?\
        (_convert=static_cast<int>(wcslen(_lpw))+1,(_convert>INT_MAX/2)?\
            FALSE:ATL::_ATL_SAFE_ALLOCA_IMPL::_AtlVerifyStackAvailable(_convert*sizeof(WCHAR))):FALSE)

#define VERIFY_STACK_FOR_A2W_RETURN(lpa, rc)\
    do {\
        if ((_lpa = (lpa))!= NULL) {\
            _convert = (static_cast<int>(strlen(_lpa))+1);\
            if (_convert>INT_MAX/2) return rc;\
            if (!ATL::_ATL_SAFE_ALLOCA_IMPL::_AtlVerifyStackAvailable(_convert*sizeof(WCHAR))) return rc;\
        }\
    } while(false)

#define VERIFY_STACK_FOR_W2A_RETURN(lpw, rc)\
    do {\
        if ((_lpw = (lpw)) != NULL) {\
            _convert = (static_cast<int>(wcslen(_lpw))+1);\
            if (INT_MAX/2<_convert) return rc;\
            if (!ATL::_ATL_SAFE_ALLOCA_IMPL::_AtlVerifyStackAvailable(_convert*sizeof(WCHAR))) return rc;\
        }\
    } while(false)
...
#define VERIFY_STACK_FOR_T2OLE(lpa) TRUE
#define VERIFY_STACK_FOR_OLE2T(lpa) TRUE

#define VERIFY_STACK_FOR_T2OLE_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_OLE2T_RETURN(lpa, rc)
...
#define VERIFY_STACK_FOR_T2OLE(lpa) VERIFY_STACK_FOR_A2W(lpa)
#define VERIFY_STACK_FOR_OLE2T(lpa) VERIFY_STACK_FOR_W2A(lpa)

#define VERIFY_STACK_FOR_T2OLE_RETURN(lpa, rc) VERIFY_STACK_FOR_A2W_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_OLE2T_RETURN(lpa, rc) VERIFY_STACK_FOR_W2A_RETURN(lpa, rc)
...
#define VERIFY_STACK_FOR_W2OLE(lpa) TRUE
#define VERIFY_STACK_FOR_OLE2W(lpa) TRUE
#define VERIFY_STACK_FOR_A2OLE(lpa) VERIFY_STACK_FOR_A2W(lpa)
#define VERIFY_STACK_FOR_OLE2A(lpa) VERIFY_STACK_FOR_W2A(lpa)

#define VERIFY_STACK_FOR_W2OLE_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_OLE2W_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_A2OLE_RETURN(lpa, rc) VERIFY_STACK_FOR_A2W_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_OLE2A_RETURN(lpa, rc) VERIFY_STACK_FOR_W2A_RETURN(lpa, rc)
...
#define VERIFY_STACK_FOR_T2A(lpa) VERIFY_STACK_FOR_W2A(lpa)
#define VERIFY_STACK_FOR_A2T(lpa) VERIFY_STACK_FOR_A2W(lpa)
#define VERIFY_STACK_FOR_T2W(lpa) TRUE
#define VERIFY_STACK_FOR_W2T(lpa) TRUE

#define VERIFY_STACK_FOR_T2A_RETURN(lpa, rc) VERIFY_STACK_FOR_W2A_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_A2T_RETURN(lpa, rc) VERIFY_STACK_FOR_A2W_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_T2W_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_W2T_RETURN(lpa, rc)
...
#define VERIFY_STACK_FOR_T2A(lpa) TRUE
#define VERIFY_STACK_FOR_A2T(lpa) TRUE
#define VERIFY_STACK_FOR_T2W(lpa) VERIFY_STACK_FOR_A2W(lpa)
#define VERIFY_STACK_FOR_W2T(lpa) VERIFY_STACK_FOR_W2A(lpa)

#define VERIFY_STACK_FOR_T2A_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_A2T_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_T2W_RETURN(lpa, rc) VERIFY_STACK_FOR_A2W_RETURN(lpa, rc)
#define VERIFY_STACK_FOR_W2T_RETURN(lpa, rc) VERIFY_STACK_FOR_W2A_RETURN(lpa, rc)
